...
<body>
    ...
    <div>
        <asp:Label ID="lblWindowWidth" runat="server" Text="Ikkunan leveys (mm):"></asp:Label>
        <asp:TextBox ID="txtWindowWidth" runat="server"></asp:TextBox><br /><br />

        <asp:Label ID="lblWindowHeight" runat="server" Text="Ikkunan korkeus (mm):"></asp:Label>
        <asp:TextBox ID="txtWindowHeight" runat="server"></asp:TextBox><br /><br />

        <asp:Label ID="lblFrameWidth" runat="server" Text="Karmipuun leveys (mm):"></asp:Label>
        <asp:TextBox ID="txtFrameWidth" runat="server">45</asp:TextBox><br /><br />
        ...
        <asp:Label ID="lblMessage" runat="server" Text="Ei ilmoituksia." Font-Bold="True"></asp:Label>
    </div>
    </form>
</body>
</html>
